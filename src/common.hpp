...
inline const std::string fileName::base(const int& t_networkSize,
...
const std::string fileName::NG(const int& t_networkSize,
                               const double& t_acceptanceThreshold,
                               const int& t_coreNum) {
    const std::string fileName = base(t_networkSize, t_acceptanceThreshold);
    return t_coreNum == -1
               ? fileName + ".txt"
               : fileName + "-" + std::to_string(t_coreNum) + ".txt";
}

const std::string fileName::NGE(const int& t_networkSize,
                                const double& t_acceptanceThreshold,
                                const unsigned& t_ensembleSize,
                                const int& t_coreNum) {
...
const std::string fileName::NGES(const int& t_networkSize,
                                 const double& t_acceptanceThreshold,
                                 const unsigned& t_ensembleSize,
                                 const std::string& t_standard,
                                 const double& t_repeater,
                                 const int& t_coreNum) {
